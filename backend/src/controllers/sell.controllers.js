...
const putProductForSell = asyncHandler(async (req, res) => {
    ...
    if(!product) {
        throw new ApiError(500, "Something went wrong while storing the product!")
    }

    return res
    .status(200)
    .json(
        new ApiResponse(200, product, "Product is stored successfully!")
    );
    
});

export { putProductForSell };